...
public class SimpleFileDialog
{
	...
	private String m_sdcardDirectory = Environment.getExternalStorageDirectory()+"/.aq/local/"; //default folder to open when opening file dialog.
	...
	private String m_dir = Environment.getExternalStorageDirectory()+"/.aq/local/";
